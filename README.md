...
**SafeMeds AI** was submitted to the **DHIS2 App Competition**. It demonstrates integration of DHIS2 Tracker with AI-powered clinical decision support using OpenFn workflow automation.

**Key innovations:**
- First known integration of Claude AI with DHIS2 Tracker for clinical safety checking
- Uses WHO AWaRe antibiotic stewardship guidelines in the AI prompt
- Fully automated — zero manual steps required after prescription completion
- Works with standard DHIS2 Tracker — no custom app required
